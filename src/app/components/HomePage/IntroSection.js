        ...
        >
            <div className="p-6 lg:p-4">
                <div className="lg:w-[1170px] mx-auto">
                    <div className="text-white font-sans mt-[85px] md:mt-[150px] lg:mt-[150px] align-middle left-0 right-0 text-[22px]  sm:text-[32px] md:text-[50px] text-center lg:text-left leading-[30px] md:leading-[50px] w-full lg:w-[500px] font-semibold mx-auto lg:mx-0">
